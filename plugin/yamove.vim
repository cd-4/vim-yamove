...
command! -nargs=0 YaMoveDown call yamove#YaMove(1, 0)
command! -nargs=0 YaMoveUp call yamove#YaMove(-1, 0)
command! -nargs=0 YaMoveIn call yamove#YaMove(1, 1)
command! -nargs=0 YaMoveOut call yamove#YaMove(-1, -1)
